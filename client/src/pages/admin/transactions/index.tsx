      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 px-4 md:px-2">
          <div className="space-y-1">
            ...
            <p className="text-forest-moss-light/70 font-bold text-xs md:text-sm">
              Review incoming payments and transaction health.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full lg:w-auto">
            <div className="bg-white px-6 py-4 rounded-3xl shadow-soft border border-white/50 flex flex-col items-start lg:min-w-[160px]">
              <span className="text-[10px] font-black text-forest-moss/40 uppercase tracking-widest mb-1">
                Revenue
              </span>
            ...
            <div className="bg-forest-moss px-6 py-4 rounded-3xl shadow-soft flex flex-col items-start lg:min-w-[160px]">
        ...
        <div className="flex flex-col md:flex-row gap-4 px-4 md:px-2">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex-1 md:flex-none px-6 py-3 md:py-4 bg-white rounded-full border border-forest-moss/5 text-forest-moss font-black text-[10px] md:text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-red-50 hover:text-red-500 transition-all shadow-sm">
              Failed Only
            </button>
          </div>
        </div>
