...
export default function ForgotPasswordForm({
  ...
  const inputClass = isPage
    ? "w-full h-11 lg:h-12 px-4 rounded-[18px] border border-slate-200 bg-white text-[#1a2f1a] text-sm lg:text-base font-bold placeholder:text-slate-300 focus:border-[#5ef037] focus:ring-4 focus:ring-[#5ef037]/10 transition-all duration-300 outline-none shadow-sm"
    ...
    <div className={isPage ? "flex flex-col gap-4 lg:gap-5" : "space-y-4"}>
      ...
      {(onBack || isPage) && (
        <button
          ...
          className={
            isPage
              ? "text-[#1a2f1a] font-black hover:text-[#5ef037] transition-colors text-center"
