        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              maxLength={500}
              disabled={isBusy}
              className="w-full bg-[#f4f5f0]/50 px-4 py-3 rounded-xl border border-[#1a2f1a]/10 focus:outline-none focus:ring-2 focus:ring-[#5ef037]/20 font-medium text-sm text-[#1a2f1a] placeholder:text-[#1a2f1a]/30 resize-none"
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              onClick={handleNext}
              disabled={isBusy}
              className="w-full bg-[#5ef037] text-white py-3.5 rounded-xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-[#4ad12d] transition-all disabled:opacity-50"
            >
              {isSubmitting ? (
                <>
